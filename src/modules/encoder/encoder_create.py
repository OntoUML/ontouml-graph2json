...
from src.modules.encoder.sparql_queries import QUERY_FUTURE_OBJECTS
from src.modules.errors import report_error_requirement_not_met
from src.modules.globals import URI_ONTOUML, URI_ONTOLOGY
